...
ai_clients = {
    ...
    'qwen': OpenAI(
        ...
        base_url="https://dashscope-intl.aliyuncs.com/compatible-mode/v1"  # 默认为新加坡地域的模型 如北京改成https://dashscope.aliyuncs.com/compatible-mode/v1
    )
}
            ...
            if current_position and current_position['side'] == 'short':
                ...
                if current_position['size'] > 0:
                    ...
                    exchange.create_market_order(
                        ...
                        params={'reduceOnly': True, 'tag': 'a2983740598bBCDE'}
                    )
                    time.sleep(1)
                    # 开多仓
                    exchange.create_market_order(
